...
export default function Register() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setError(err.response?.data?.message || t('auth.register_failed_msg'));
        } finally {
            setIsLoading(false);
        }
    };
        ...
        <div className="min-h-screen flex bg-gray-50">
            ...
            <div className="hidden lg:flex w-1/2 bg-blue-600 relative overflow-hidden items-center justify-center">
                ...
                <div className="relative z-10 text-white p-12 max-w-lg text-center animate-fade-in">
                    <h1 className="text-5xl font-extrabold mb-6 tracking-tight">{t('auth.register_hero_title')}</h1>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 overflow-y-auto">
                <div className="w-full max-w-md space-y-8 animate-slide-in-right my-auto">
                    <div className="text-center lg:text-left">
                        <h2 className="text-4xl font-extrabold text-gray-900 mb-2">{t('auth.register_title')}</h2>
